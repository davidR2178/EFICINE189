...
if($_POST['email'] || $_POST['contraseña']){
   		...
   		$row = $result->fetch_array(MYSQLI_ASSOC);
							...
							if (crypt($_POST['contrasena'], $row['password']) === $row['password']) {
									...
									if($_POST['email']=="ale@avantipictures.com"){header('Location: http://www.industriacreativa.com.mx/eficine/ale_florida.php?email='.$mail.'');exit;} 
					...
					else{header('Location: http://localhost:8888/eficine');exit;}
}
// En caso de que esta sea la primera vez que se carga la pagina
else{
?>
...
<div id="login" style="position:absolute; width:100%; height:100%">
	<div id="login_div" style="position:relative; width:312px; height:120px; margin:15% auto; background: #666666">
            	<form action="/eficine/index.php" method="post" id="form" name="form"  enctype="application/x-www-form-urlencoded">
                				<div>
